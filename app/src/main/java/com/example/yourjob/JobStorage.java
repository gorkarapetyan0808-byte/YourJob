...
public class JobStorage {
        ...
        if (json != null) {
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    job.timestamp = obj.optLong("timestamp", 0);
                    jobs.add(job);
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public static void addProfessionalSampleJobs() {
        ...
        String[][] data = {
            ...
            {"Senior Engineer", "Horizon 95", "Calculate and design reinforced concrete structures for modern residential complexes. AutoCAD/Revit skills required.", "25-60", "Construction / Architecture", "010-223344", "Gyumri"},
